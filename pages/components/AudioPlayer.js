...
const AudioPlayer = () => {
  ...
  <div ref={containerRef} className="w-full flex flex-col justify-end items-center p-4 absolute z-5 bottom-0 left-0 mt-40"> {/*Added mt-40 for top margin */}
    ...
    <div className="flex items-center mb-2">
      ...
      <div className="relative flex flex-col md:flex-row md:items-center md:justify-center md:ml-0 ml-[-60px] md:mt-0 mt-[80px] w-full mb-4"> {/* Reduced ml-[-60px] */}
    ...
    >
      <div
        style={{
          width: `${(audioRefs.current[playingTrackIndex]?.currentTime / audioRefs.current[playingTrackIndex]?.duration) * 100 || 0}%`,
          height: "100%",
